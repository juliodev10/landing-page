...
<body>
	<header>
		<div class="container">
            <div class="conteudo">
                <div class="logo">
                    <img src="<?=URL_BASE?>resources/imagens/logo.png" alt="Logo All-in"> 
                </div>
                <div class="menu-lateral">
                    ...
                    <div class="redes-sociais">
                        <p>Siga-me:</p>
                        <a href="https://www.facebook.com/julio.orion.75" target="_blank"><i class="fa-brands fa-facebook-f"></i></a>
